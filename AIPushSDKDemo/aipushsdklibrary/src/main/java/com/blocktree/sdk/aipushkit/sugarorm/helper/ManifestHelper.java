...
import static com.blocktree.sdk.aipushkit.sugarorm.util.ContextUtil.getPackageManager;
import static com.blocktree.sdk.aipushkit.sugarorm.util.ContextUtil.getPackageName;
...
public final class ManifestHelper {
    ...
    private static String  databaseName="sugar_blocktree.db";
    private static String  domainPackageName="";
    private static Boolean databaseDebug=true;
    ...
    public static boolean isDebugEnabled() {
        return (null == debugEnabled) ? debugEnabled = databaseDebug : debugEnabled;
    }
