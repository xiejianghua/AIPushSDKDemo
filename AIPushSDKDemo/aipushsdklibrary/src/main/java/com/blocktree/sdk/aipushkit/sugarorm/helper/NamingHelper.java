package com.blocktree.sdk.aipushkit.sugarorm.helper;

import com.blocktree.sdk.aipushkit.sugarorm.annotation.Column;
import com.blocktree.sdk.aipushkit.sugarorm.annotation.Table;
...
public final class NamingHelper {
     ...
     *         with {@link com.blocktree.sdk.aipushkit.sugarorm.annotation.Column} then the {@link com.blocktree.sdk.aipushkit.sugarorm.annotation.Column#name()} will be
     ...
     * @return if the given class is annotated with {@link com.blocktree.sdk.aipushkit.sugarorm.annotation.Table} then the value for
     *         {@link com.blocktree.sdk.aipushkit.sugarorm.annotation.Table#name()} will be returned. Else, the class' simple name will
