package com.blocktree.sdk.aipushkit.service;
...
import com.blocktree.sdk.aipushkit.receiver.WakeReceiver;
...
public class GrayService extends Service {
    ...
    public void onCreate() {
        AILog.e(TAG, "GrayService->onCreate");
        super.onCreate();
    }
    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        AILog.e(TAG, "GrayService->onStartCommand");
    ...
    public void onDestroy() {
        AILog.e(TAG, "GrayService->onDestroy");
        super.onDestroy();
    }
